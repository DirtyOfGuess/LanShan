...
public class Driver {
    public static void main(String[] args) throws ParseException {
        ...
        //定义失物数据
        Lost lost1 = new Lost(60,10,"Key","拾取地点为5401");
        Lost lost2 = new BookLost(50,20,"物主学号为2021218426","博物杂志");
        Lost lost3 = new CardLost(200,30,"拾取地点为3206","张亮",2021214867);
        Lost lost4 = new Lost(100,40,"Phone","手机是华为手机");
